 ...
 * @param classification the complete verdict, kind COMMAND_HANDLER
 * @since 7.0.0
 */
public record CommandHandler(TypeId id, TypeStructure structure, Classification classification)
    ...
    public CommandHandler {
        ...
        KindCoherence.require(ArchKind.COMMAND_HANDLER, classification, id);
    }
