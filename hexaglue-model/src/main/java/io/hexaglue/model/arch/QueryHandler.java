 ...
 * @param classification the complete verdict, kind QUERY_HANDLER
 * @since 7.0.0
 */
public record QueryHandler(TypeId id, TypeStructure structure, Classification classification)
    ...
    public QueryHandler {
        ...
        KindCoherence.require(ArchKind.QUERY_HANDLER, classification, id);
    }
